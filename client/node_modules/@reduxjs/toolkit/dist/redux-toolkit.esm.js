...
function createUnsortedStateAdapter(selectId) {
  ...
  function mapMutably(map, state) {
    ...
    var updates = changes.filter(function (_ref2) {
      var id = _ref2.id;
      return id in state.entities;
    });
...
export { configureStore, createAction, createAsyncThunk, createEntityAdapter, createReducer, createSerializableStateInvariantMiddleware, createSlice, findNonSerializableValue, getDefaultMiddleware, getType, isPlain, unwrapResult };
