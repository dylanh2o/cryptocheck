...
declare interface EntityStateAdapter<T> {
    ...
    removeMany<S extends EntityState<T>>(state: S, keys: PayloadAction<EntityId[]>): S;
    removeAll<S extends EntityState<T>>(state: S): S;
    updateOne<S extends EntityState<T>>(state: S, update: Update<T>): S;
    updateOne<S extends EntityState<T>>(state: S, update: PayloadAction<Update<T>>): S;
    updateMany<S extends EntityState<T>>(state: S, updates: Update<T>[]): S;
    updateMany<S extends EntityState<T>>(state: S, updates: PayloadAction<Update<T>[]>): S;
    ...
    upsertMany<S extends EntityState<T>>(state: S, entities: PayloadAction<T[]>): S;
