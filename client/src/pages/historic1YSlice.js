...
export const fetchHistoric1YCurrency = createAsyncThunk(
	...
	async currency => {
		...
		const requestHistoric1Y = await fetch('https://rest.coinapi.io/v1/ohlcv/BITSTAMP_SPOT_' + currency + '_USD/history?period_id=1DAY&time_start='+formattedDate+'T00:00:00&limit=10', {
			method: 'GET',
